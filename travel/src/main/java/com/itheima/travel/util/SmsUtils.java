...
public class SmsUtils {
    ...
    // 需开发者指定
    private static String accessKeyId = "LTAI4G2GEWuHBSLmetjjAdiL";

    // 需开发者指定
    private static String accessKeySecret = "8ZrgMXINeI6J9weovmuXnhr8SHBedN";
    ...
    /*public static void main(String[] args) throws Exception {
        SendSmsResponse sendSmsResponse = sendSms("15216126503", "清风E旅", "SMS_190272195", "{\"code\":\"123456\"}");
