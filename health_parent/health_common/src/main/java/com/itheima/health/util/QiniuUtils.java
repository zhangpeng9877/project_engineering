...
public class QiNiuUtils {
    ...
    private static final String ACCESSKEY = "XL_S-zzc_LKgS5lR-yuEDMxBJds9pwnvp23ntcsG";
    private static final String SECRETKEY = "gsoJamfPfuIDoR0UocoO-4DTQweyn2W_fhG73W-_";
    private static final String BUCKET = "zpxiaoqi";
    public static final String DOMAIN= "http://qcdcwehe2.bkt.clouddn.com/";
